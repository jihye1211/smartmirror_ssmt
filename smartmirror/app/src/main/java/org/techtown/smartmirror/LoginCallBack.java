...
public class LoginCallBack extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.registerCallback(mCallbackManger, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                Intent mainIntent = new Intent(LoginCallBack.this, MainActivity.class);
            ...
            public void onCancel() {
                ...
                Toast.makeText(LoginCallBack.this, "페이스북 로그인이 취소 되었습니다.", Toast.LENGTH_SHORT).show();
